    ...
    <main className={styles.page}>
      <div className={styles.header}>
        <div>
          ...
          <p>Key được cấp sau khi hệ thống xác nhận đúng giao dịch SePay.</p>
        </div>
        ...
        <div className={styles.grid}>
          ...
          {order ? (
            ...
            <section className={styles.card + ' ' + styles.instructions}>
              ...
              <p>
                Sau khi chuyển khoản, SePay gửi webhook về máy chủ. Đơn lặp
                hoặc giao dịch sai sẽ được lưu để quản trị viên đối soát.
              </p>
            </section>
          )}
        </div>
